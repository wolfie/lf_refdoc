<?php
define('LF_LIGHTFRAME_PATH', '/Users/henrikpaul/Sites/LightFrame'); // The path to where LightFrame is installed
define('LF_PROJECT_PATH',dirname(__FILE__)); // The path where your project files are
